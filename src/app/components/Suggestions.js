      ...
      <div className="flex flex-wrap justify-center gap-2">
        {suggestions.map((suggestion) => (
          <button
            ...
            className="group flex items-center gap-2 rounded-lg border border-[#E2E8F0] bg-white px-3 py-2.5 text-xs font-medium text-[#64748B] shadow-[0_1px_2px_rgba(15,23,42,0.03)] transition-all duration-200 hover:-translate-y-0.5 hover:border-[#BFDBFE] hover:bg-[#F8FBFF] hover:text-[#2563EB] hover:shadow-[0_6px_16px_rgba(37,99,235,0.07)] active:translate-y-0 sm:px-3.5"
          >
